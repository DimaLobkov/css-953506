...
namespace laba3
{
    class Program
    {
        static void Main()
        {
            int angles, sidelenght;
            Console.WriteLine("Введите количество углов и длину стороны");
            while(!Int32.TryParse(Console.ReadLine(),out angles))
                Console.WriteLine("Введите число:");
            while (!Int32.TryParse(Console.ReadLine(), out sidelenght))
                Console.WriteLine("Введите число:");
            Figure shape = new Figure(angles,sidelenght,true);
            Console.WriteLine("Цвет поверхности сверху/снизу:");
