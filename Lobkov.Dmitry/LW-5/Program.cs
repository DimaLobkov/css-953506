...
namespace _5
{
    ...
    class Human
    {
        ...
        public virtual string KindOfSports { get; set; }
    ...
    class Sportsman : Human
    {
        ...
        public virtual string IsOutstanding { get; }
        ...
        public virtual void PersonalRecord(Sportsman sportsman) { }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                sportsman = new Swimmer(firstname, lastname, middlename, record);
            ...
            {
                sportsman = new Weghtlifter(firstname, lastname, middlename, record);
