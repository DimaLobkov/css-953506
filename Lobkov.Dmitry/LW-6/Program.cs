...
namespace laba
{
    ...
    class TheBestOne : ICompareTo<Employee>
    {
        public void Compare(Employee obj1, Employee obj2)
        {
            ...
            {
                Console.WriteLine("both employees");
            }
        }
    }
        ...
        static void Main(string[] args)
        {
            ...
            switch (select)
            {
                ...
                case 3:
                    ...
                    theBestOne.Compare(employee1, employee2);
                    break;
            }
        }
    }
