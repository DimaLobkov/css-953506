...
namespace laba
{
    ...
    class Employee : Human, ISpecifications
    {
        //поля
        ...
        public int IqSet
        {
            set
            {
                ...
                Notify?.Invoke($"Employee has {_iq} IQ lvl");
            }
        }
        ...
        public string Recommend
        {
            ...
            set
            {
                ...
                {
                    _isRecommend = true;
                    Notify?.Invoke("Employee has good reputation");
                }

                else
                {
                    _isRecommend = false;
                    Notify?.Invoke("Employee has bad reputation");
                }
            }
        }
    ...
    class Program
    {
        public static void FirstEmp()
        {
            Console.WriteLine("It was the first employee.");
        }
        ...
        static void Main(string[] args)
        {
            ...
            employee1.Notify += mes => Console.WriteLine(mes);
            employee2.Notify += delegate (string mes)
            {
            ...
            try
            {
                ...
                {
                    throw new Exception("Your select from 1 to 3");
                }
                Console.Clear();
                employee1.message += FirstEmp;
                switch (select)
                {
                    case 1:
                        employee1.Show(employee1.message);
                        break;
                    case 2:
                        employee2.Show(employee1.message);
                        break;
                    case 3:
            ...
            {
                Console.WriteLine($"Exception: {newEx.Message}");
            }     
        }
    }
}
